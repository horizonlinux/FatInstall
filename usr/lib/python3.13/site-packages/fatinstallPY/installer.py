...
Gtk.IconTheme.get_default().append_search_path("/usr/share/horizonlinux/icons")
...
class Installer(GObject.Object):
    ...
    def _get_flatpak_status(self):
        try:
            ...
            warn("No flatpak support, install flatpak and gir1.2-flatpak-1.0 and restart fatinstall to enable it.")
