...
import gettext
APP = 'mint-common'
LOCALE_DIR = "/usr/share/horizonlinux/locale"
t = gettext.translation(APP, LOCALE_DIR, fallback=True)
_ = t.gettext

from aptdaemonGUI.gtk3widgets import AptConfirmDialog
...
class FlatpakProgressWindow(Gtk.Dialog):
    ...
    Intended to be used when not working as part of a parent app (like fatinstall)
    """
